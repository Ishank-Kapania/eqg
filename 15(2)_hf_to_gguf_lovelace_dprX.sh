...
process_model "llamadpr"
process_model "gemmadpr"
process_model "mistraldpr"
...
singularity exec instance://ollama_instance ollama create gemmadpr -f /home2/ /my_code/15_Modelfile_gemmadprX
singularity exec instance://ollama_instance python3 /home2/ /my_code/15\(3\)_ollama_dpr.py /home2/ /my_code/7_output /home2/ /my_code/gemmadpr_outputX gemmadpr
singularity exec instance://ollama_instance ollama rm gemmadpr
singularity instance stop ollama_instance

singularity instance start --nv --bind /scratch/ik:/scratch/ik /home2/ /ollama.sif ollama_instance
singularity exec instance://ollama_instance ollama create  -f /home2/ /my_code/15_Modelfile_mistraldprX
singularity exec instance://ollama_instance python3 /home2/ /my_code/15\(3\)_ollama_dpr.py /home2/ /my_code/7_output /home2/ /my_code/mistraldpr_outputX mistraldpr
singularity exec instance://ollama_instance ollama rm mistraldpr
singularity instance stop ollama_instance

singularity instance start --nv --bind /scratch/ik:/scratch/ik /home2/ /ollama.sif ollama_instance
singularity exec instance://ollama_instance ollama create  -f /home2/ /my_code/15_Modelfile_llamadprX
singularity exec instance://ollama_instance python3 /home2/ /my_code/15\(3\)_ollama_dpr.py /home2/ /my_code/7_output /home2/ /my_code/llamadpr_outputX llamadpr
singularity exec instance://ollama_instance ollama rm llamadpr
singularity instance stop ollama_instance
